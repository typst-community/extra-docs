...
- [v0.14.0 (15 MiB, retrieved on 2025-11-04)](./typst.app_docs_v0.14.0_7248b445-2025-11-04.zim)
- [v0.13.1 (14 MiB, retrieved on 2025-09-11)](./typst.app_docs_v0.13.1_62cd2ab2-2025-09-11.zim)

The above `*.zim` files were created by running [Zimit](https://zimit.kiwix.org) against [typst.app/docs/](https://typst.app/docs/). (To circumvent Zimit issues, some files have been patched. Refer to [`patch_zim.py`](./patch_zim.py) for details.)

To view the contents, you will need a ZIM file reader, which usually means [Kiwix](https://get.kiwix.org/en/solutions/applications/download-options/).
...
![Screenshot](./kiwix-browser-extension.png)
